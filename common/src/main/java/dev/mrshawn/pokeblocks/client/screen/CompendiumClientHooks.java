...
/**
 * Tiny client-only indirection so {@link dev.mrshawn.pokeblocks.item.custom.CompendiumItem} can open
 * the screen without statically referencing {@link Minecraft} on the server class path. Only invoked
