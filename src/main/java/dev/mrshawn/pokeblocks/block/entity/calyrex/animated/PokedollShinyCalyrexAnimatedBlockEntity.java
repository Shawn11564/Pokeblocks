...
public class PokedollShinyCalyrexAnimatedBlockEntity extends BlockEntity implements GeoBlockEntity {

	private AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

	public PokedollShinyCalyrexAnimatedBlockEntity(BlockPos pos, BlockState state) {
		super(ModBlockEntities.POKEDOLL_SHINY_CALYREX_ANIMATED_BLOCK_ENTITY, pos, state);
	}
