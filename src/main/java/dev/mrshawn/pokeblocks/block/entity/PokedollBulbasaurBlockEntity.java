...
public class PokedollBulbasaurBlockEntity extends BlockEntity implements GeoBlockEntity {

	private AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

	public PokedollBulbasaurBlockEntity(BlockPos pos, BlockState state) {
		super(ModBlockEntities.POKEDOLL_BULBASAUR_BLOCK_ENTITY, pos, state);
	}
