...
public class PokedollCharmanderBlockEntity extends BlockEntity implements GeoBlockEntity {

	private AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

	public PokedollCharmanderBlockEntity(BlockPos pos, BlockState state) {
		super(ModBlockEntities.POKEDOLL_CHARMANDER_BLOCK_ENTITY, pos, state);
	}
