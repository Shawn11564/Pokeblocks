...
public class PokedollShinyBulbasaurPosedBlockEntity extends BlockEntity implements GeoBlockEntity {

	private AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

	public PokedollShinyBulbasaurPosedBlockEntity(BlockPos pos, BlockState state) {
		super(ModBlockEntities.POKEDOLL_SHINY_BULBASAUR_POSED_BLOCK_ENTITY, pos, state);
	}
