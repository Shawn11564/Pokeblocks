...
public class PokedollGiganticHeadpileBlockEntity extends HeadPileBlockEntity {
	...
	public PokedollGiganticHeadpileBlockEntity(BlockPos pos, BlockState state) {
		super(BlockEntityTypeRegistry.get(PokedollGiganticHeadpileBlockEntity.class), pos, state);
	}
