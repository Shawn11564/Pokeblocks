...
public class EiscueShinyHeadpileBlockEntity extends HeadPileBlockEntity {
	...
	public EiscueShinyHeadpileBlockEntity(BlockPos pos, BlockState state) {
		super(BlockEntityTypeRegistry.get(EiscueShinyHeadpileBlockEntity.class), pos, state);
	}
