...
public class PokedollShinyBulbasaurBlockEntity extends BlockEntity implements GeoBlockEntity {

	private AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

	public PokedollShinyBulbasaurBlockEntity(BlockPos pos, BlockState state) {
		super(ModBlockEntities.POKEDOLL_SHINY_BULBASAUR_BLOCK_ENTITY, pos, state);
	}
