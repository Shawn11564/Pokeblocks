...
public class PokedollBulbasaurPosedBlockEntity extends BlockEntity implements GeoBlockEntity {

	private AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

	public PokedollBulbasaurPosedBlockEntity(BlockPos pos, BlockState state) {
		super(ModBlockEntities.POKEDOLL_BULBASAUR_POSED_BLOCK_ENTITY, pos, state);
	}
