...
public class PokedollBlockItem extends BlockItem implements GeoItem {
	...
	public PokedollBlockItem(Block block, net.minecraft.item.Item.Settings settings, DollRarity rarity, int dexNumber, Supplier<PokedollBlockItemModel> blockItemModelSupplier) {
