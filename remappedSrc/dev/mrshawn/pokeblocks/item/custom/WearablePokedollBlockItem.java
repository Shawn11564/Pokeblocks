...
public class WearablePokedollBlockItem extends PokedollBlockItem implements Equipment {
	...
	public WearablePokedollBlockItem(Block block, net.minecraft.item.Item.Settings settings, DollRarity rarity, Supplier<PokedollBlockItemModel> blockItemModelSupplier) {
