...
import com.example.examplemod.data.datafixer.fixes.PreservePokedollBlockEntitiesFix;
import com.example.examplemod.data.datafixer.fixes.PreservePokedollItemsFix;
import com.example.examplemod.data.datafixer.schemas.V1;
import com.example.examplemod.data.datafixer.schemas.V2;
...
public class PokeblocksDataFixers {
    ...
    private static void addFixers(DataFixerBuilder builder) {
        ...
        UnaryOperator<String> dollRenamer = oldName -> {
            ...
            if (matcher.find()) {
                return ExampleModCommon.MOD_ID+":pokedoll";
            }
            return oldName;
        };
        ...
        assert 2 == ExampleModCommon.DATA_FIXER_VERSION : "DATA_FIXER_VERSION does not match the latest schema version!";
    }
}
